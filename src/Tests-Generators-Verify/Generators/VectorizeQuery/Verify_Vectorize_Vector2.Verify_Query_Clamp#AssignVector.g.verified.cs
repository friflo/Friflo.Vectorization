...
namespace VerifyVectorize
{
    public partial class MyExample
    {
        ...
        public ArchetypeQuery AssignVectorQuery(EntityStore _store, Vector2 min, Vector2 max, bool vectorized = true)
        {
