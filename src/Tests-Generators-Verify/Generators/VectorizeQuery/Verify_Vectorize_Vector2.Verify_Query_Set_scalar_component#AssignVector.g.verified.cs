...
namespace VerifyVectorize
{
    ...
    #region private members
            ...
            ReadOnlySpan<global::VerifyVectorize.FloatComponent2> factor2)
        {
            ...
            if (factor2.Length < paddedCount) VectorUtils.ThrowBufferTooSmall(nameof(factor2));
            ...
            fixed (global::VerifyVectorize.FloatComponent2* factor2_first = factor2)
            {
                ...
                float* factor2_ptr = (float*)factor2_first;
                ...
                for (; i < paddedCount; i += 16)
                {
                    ...
                    Vector256<float> factor_0;  // FloatComponent
                    Vector256<float> factor_1;  // FloatComponent
