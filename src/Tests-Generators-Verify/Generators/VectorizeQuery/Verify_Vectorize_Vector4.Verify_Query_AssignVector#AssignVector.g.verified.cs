...
namespace VerifyVectorize
{
    public partial class MyExample
    {
        ...
        public ArchetypeQuery AssignVectorQuery(EntityStore _store, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                var vectorSpan = chunk.Chunk2.ArchetypeComponents.AsSpan();
                int n = 0;
                if (!vectorized) goto EntityLoop;
                if (Avx.IsSupported) {
                    n = _AssignVector_Avx(_entities.Length, positionSpan, vectorSpan);
                }
            EntityLoop:
    ...
    #region private members
            ...
            ReadOnlySpan<global::VerifyVectorize.Velocity4> vector)
        {
            ...
            if (vector.Length < paddedCount) VectorUtils.ThrowBufferTooSmall(nameof(vector));
            ...
            fixed (global::VerifyVectorize.Velocity4* vector_first = vector)
            {
                ...
                float* vector_ptr = (float*)vector_first;
