...
public partial class ShaderExample
{
    ...
    private static ref readonly PipelineCache _RenderCube_GPU_CreatePipelineCache(WgpuDevice device, RenderConfig config)
    {
        ...
        if (!layout_0.IsCreated) {
            ...
            device.BindGroupLayoutStorageTexture(TextureFormat.RGBA8Unorm, StorageTextureAccess.ReadOnly, TextureViewDimension.D2D);
    ...
    private static ReadOnlySpan<byte> _RenderCube_GPU_FragmentShader() => WgpuResource.GetResource(typeof(ShaderExample), "shaders/sampleTextureMixColor.frag.wgsl");
