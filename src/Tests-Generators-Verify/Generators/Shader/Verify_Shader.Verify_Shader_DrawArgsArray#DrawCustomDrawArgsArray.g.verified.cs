...
public partial class ShaderExample
{
        ...
        DrawArgs[]                  customArgs)
    {
		...
		recorder.Init(_DrawCustomDrawArgsArray_GPU_ShaderId, "DrawCustomDrawArgsArray_encoder"u8);
        ...
        if (!bindGroupCache.bindGroup0.TryGetValue(key_0, out var bindGroup0)) {
            ...
            bindGroup0 = recorder.CreateBindGroup(pipelineCache.layouts[0], "DrawCustomDrawArgsArray_bindGroup0"u8);
    ...
    private const  ulong        _DrawCustomDrawArgsArray_GPU_layout_0_Key        =  0xad2bca77479a0a64;

    private static ulong        _DrawCustomDrawArgsArray_GPU_WgslHash            => 0x0UL;  // support Hot-Reload
