...
public partial struct ShaderExample
{
        ...
        DrawArgs                    args)
    {
        ...
        // --- bind group 0
        pass_.SetBindGroupUniform(0, 0, ref bindGroupCache.bindGroup_0, uniforms, pipelineCache,"RenderTunnel_bindGroup_0"u8);
    ...
    private static ulong        _RenderTunnel_GPU_WgslHash            => 0x8c5de2fceb99d1ceUL;  // support Hot-Reload
    ...
    private static readonly WgpuShader[] _RenderTunnel_GPU_Shaders = [
        new("shaders/renderTest/raymarcher_no_texture.wgsl"),
    ];
