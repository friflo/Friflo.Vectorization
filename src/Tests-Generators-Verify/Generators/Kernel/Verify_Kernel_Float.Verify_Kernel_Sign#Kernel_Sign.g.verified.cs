...
namespace VerifyVectorize
{
        ...
        in float           value)
    {
        ...
        recorder.InitKernel(_Kernel_Sign_GPU_KernelId, "Kernel_Sign"u8);
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup))
        {
            ...
            bufferGroup = recorder.CreateBindGroup(pipelineCache.layouts[0], "Kernel_Sign_buffers"u8);
        ...
        pass.SetBindGroupUniform(1, 0, ref bindGroupCache.uniformGroup, uniforms, pipelineCache, "Kernel_Sign_uniforms"u8);
