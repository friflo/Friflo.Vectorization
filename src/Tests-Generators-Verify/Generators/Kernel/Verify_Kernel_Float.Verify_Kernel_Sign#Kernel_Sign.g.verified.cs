...
namespace VerifyVectorize
{
    ...
    private static ref WgpuEffect _Kernel_Sign_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, false, _Kernel_Sign_GPU_BufferLayoutKey, "Kernel_Sign_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, true, _Kernel_Sign_GPU_UniformLayoutKey, "Kernel_Sign_uniforms"u8);
        }
