...
namespace VerifyVectorize
{
    ...
    private static ref WgpuEffect _MoveExample_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, false, _MoveExample_GPU_BufferLayoutKey, "MoveExample_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, true, _MoveExample_GPU_UniformLayoutKey, "MoveExample_uniforms"u8);
        }
