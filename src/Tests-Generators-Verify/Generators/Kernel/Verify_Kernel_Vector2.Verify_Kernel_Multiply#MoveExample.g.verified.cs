...
namespace VerifyVectorize
{
        ...
        in float           deltaTime)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup)) {
            ...
            bufferGroup = recorder.CreateBindGroupNew(pipelineCache.bufferLayout, entries, "MoveExample_buffers"u8);
        ...
        pass.SetUniformBindGroup(1, pipelineCache, ref bindGroupCache.uniformGroup, uniforms, "MoveExample_uniforms"u8);
    ...
    private static ref ComputeCache _MoveExample_GPU_CreateComputeCache(WgpuDevice device)
    {
        // @group(0)
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, false, _MoveExample_GPU_BufferLayoutKey, "MoveExample_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, true, _MoveExample_GPU_UniformLayoutKey, "MoveExample_uniforms"u8);
        }
