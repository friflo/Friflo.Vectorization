...
namespace Tests.Generators.VectorizeQuery
{
    public partial class Test_Vector2_Avx
    {
        ...
        public static ArchetypeQuery Multiply_Vector2_LerpQuery(EntityStore _store, Vector2 dst, float amount, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _Multiply_Vector2_Lerp_Avx(_entities.Length, srcSpan, dst, amount);
                }
            EntityLoop:
