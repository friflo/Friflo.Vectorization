...
namespace Tests.Generators.VectorizeQuery
{
    public partial class Test_Vector3_Avx
    {
        ...
        public static ArchetypeQuery NativeSoA_Vector3Query(EntityStore _store, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _NativeSoA_Vector3_Avx(positionSpan, chunk.Chunk1.GetStrideSoA(), velocitySpan, chunk.Chunk2.GetStrideSoA());
                }
            EntityLoop:
    ...
    #region private members
        ...
        [SkipLocalsInit]
        private static unsafe int _NativeSoA_Vector3_Avx(
            Span<float> position,
            int position_stride,
            Span<float> velocity,
            int velocity_stride)
