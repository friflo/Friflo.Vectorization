...
namespace Kernel.Lab
{
    ...
    private static ref WgpuEffect _Assign_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, false, _Assign_GPU_BufferLayoutKey, "Assign_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, true, _Assign_GPU_UniformLayoutKey, "Assign_uniforms"u8);
        }
