...
namespace Kernel.Lab
{
        ...
        in InBuffer   <float> input)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup))
        {
            ...
            bufferGroup = recorder.CreateBindGroup(pipelineCache.layouts[0], "ReadOnly_buffers"u8);
        ...
        pass.SetBindGroupUniform(1, 0, ref bindGroupCache.uniformGroup, uniforms, pipelineCache, "ReadOnly_uniforms"u8);
