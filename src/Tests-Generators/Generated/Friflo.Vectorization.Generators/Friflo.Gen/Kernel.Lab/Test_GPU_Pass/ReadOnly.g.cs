...
namespace Kernel.Lab
{
        ...
        in InBuffer   <float> input)
    {
        ...
        {
            recorder.AddBindGroupEntryBuffer(0, input.Buffer);
    ...
    private static ref readonly ComputeCache _ReadOnly_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, _ReadOnly_GPU_BufferLayoutKey, "ReadOnly_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, _ReadOnly_GPU_UniformLayoutKey, "ReadOnly_uniforms"u8);
        }
