...
namespace Kernel.Generators
{
        ...
        in InBuffer   <Vector4> velocity)
    {
        ...
        if (!bufferGroup.IsCreated) {
            ...
            device.UpdateComputeCache(_Multiply_GPU_KernelId, bufferGroup, buffers.hash);
        }
    ...
    private static ref WgpuComputeEffect _Multiply_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        return ref device.CreateComputeEffect(_Multiply_GPU_KernelId, _Multiply_GPU_WgslHash, pipeline, default, bufferLayout, uniformLayout);
    }
