...
namespace Kernel.Generators
{
    ...
    private static ref ComputeCache _Multiply_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, _Multiply_GPU_BufferLayoutKey, "Multiply_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, _Multiply_GPU_UniformLayoutKey, "Multiply_uniforms"u8);
        }
