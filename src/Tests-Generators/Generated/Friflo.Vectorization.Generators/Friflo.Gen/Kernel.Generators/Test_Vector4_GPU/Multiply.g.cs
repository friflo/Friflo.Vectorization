...
namespace Kernel.Generators
{
        ...
        in InBuffer   <Vector4> velocity)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup))
        {
            ...
            bufferGroup = recorder.CreateBindGroup(pipelineCache.bufferLayout, "Multiply_buffers"u8);
        ...
        pass.SetBindGroupUniform(1, 0, ref bindGroupCache.uniformGroup, uniforms, pipelineCache, "Multiply_uniforms"u8);
    ...
    private static ref readonly ComputeCache _Multiply_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated)
        {
            ...
            bufferLayout = device.CreateBindGroupLayout(ShaderStage.Compute, _Multiply_GPU_BufferLayoutKey, "Multiply_buffers"u8);
        }
        // @group(1)
