...
namespace Kernel.Generators
{
    ...
    private static ref readonly ComputeCache _Arithmetic_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, _Arithmetic_GPU_BufferLayoutKey, "Arithmetic_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, _Arithmetic_GPU_UniformLayoutKey, "Arithmetic_uniforms"u8);
        }
