...
namespace Kernel.Generators
{
        ...
        in Vector4         max)
    {
        ...
        pass.SetUniform(ref effect, uniforms, "Misc_uniforms"u8);
    ...
    private static ref WgpuEffect _Misc_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, false, _Misc_GPU_BufferLayoutKey, "Misc_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, true, _Misc_GPU_UniformLayoutKey, "Misc_uniforms"u8);
        }
