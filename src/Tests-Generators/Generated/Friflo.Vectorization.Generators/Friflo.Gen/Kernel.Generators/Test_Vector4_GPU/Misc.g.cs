...
namespace Kernel.Generators
{
        ...
        in Vector4         max)
    {
        ...
        recorder.InitKernel(_Misc_GPU_KernelId, "Misc"u8);
        ...
        pass.SetBindGroupUniform(1, 0, ref bindGroupCache.uniformGroup, uniforms, pipelineCache, "Misc_uniforms"u8);
    ...
    private static ref readonly ComputeCache _Misc_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        {
            device.BindGroupLayoutBuffer(0, BufferBindingType.Storage);         // var<storage, read_write>  position_arr: array<vec4<f32>>;
            device.BindGroupLayoutBuffer(1, BufferBindingType.ReadOnlyStorage); // var<storage, read      >  velocity_arr: array<vec4<f32>>;
