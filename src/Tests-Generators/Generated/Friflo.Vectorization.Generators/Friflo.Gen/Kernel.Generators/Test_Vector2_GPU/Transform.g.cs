...
namespace Kernel.Generators
{
        ...
        in Matrix4x4       matrix)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup)) {
            ...
            bufferGroup = recorder.CreateBindGroup(pipelineCache.bufferLayout, entries, "Transform_buffers"u8);
        ...
        pass.SetUniformBindGroup(1, ref bindGroupCache.uniformGroup, pipelineCache, uniforms, "Transform_uniforms"u8);
    ...
    private static ref ComputeCache _Transform_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, false, _Transform_GPU_BufferLayoutKey, "Transform_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, true, _Transform_GPU_UniformLayoutKey, "Transform_uniforms"u8);
        }
