...
namespace Kernel.Generators
{
        ...
        in float           deltaTime)
    {
        ...
        ref var effect = ref device.GetComputeEffect(_Move_GPU_KernelId, _Move_GPU_WgslHash);
        if (!effect.IsCreated) {
        ...
        pass.SetUniformBindGroup(1, ref effect, uniforms, "Move_uniforms"u8);
    ...
    private static ref WgpuComputeEffect _Move_GPU_CreateEffect(WgpuDevice device)
    {
        // @group(0)
        ...
        return ref device.CreateEffect(_Move_GPU_KernelId, _Move_GPU_WgslHash, pipeline, default, bufferLayout, uniformLayout);
    }
