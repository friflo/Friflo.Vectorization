...
namespace Kernel.Generators
{
        ...
        in float           deltaTime)
    {
        ...
        recorder.Init(_Move_GPU_EffectSlot);
        ...
        var encoder = recorder.GetEncoder("Move"u8);
        using (var pass = encoder.BeginComputePass("Move"u8))
        {
            ...
            var uniformGroup = recorder.CreateBindGroup(effect.uniformLayout, entry, "Move_uniforms"u8);
        ...
        recorder.Finish(encoder, "Move"u8);
