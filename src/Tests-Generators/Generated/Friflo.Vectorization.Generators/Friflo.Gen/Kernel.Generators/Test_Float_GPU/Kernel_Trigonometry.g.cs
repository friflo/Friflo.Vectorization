...
namespace Kernel.Generators
{
    ...
    private static ref readonly ComputeCache _Kernel_Trigonometry_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        return ref device.CreateComputeCache(_Kernel_Trigonometry_GPU_KernelId, _Kernel_Trigonometry_GPU_WgslHash, pipeline, bufferLayout, uniformLayout, bindGroupCache);
    }
