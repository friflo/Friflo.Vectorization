...
namespace Kernel.Generators
{
    public partial class Test_Float_GPU
    {
        ...
        public static void Kernel_TrigonometryKernel(
            ...
            ComputeMode mode = ComputeMode.Device)
        {
            ...
            if (buffers.ComputeGPU) {
                _Kernel_Trigonometry_GPU(buffers, position, velocity, value);
                return;
            }
    ...
    private static void _Kernel_Trigonometry_GPU(
        ...
        in float           value)
    {
        ...
        recorder.InitKernel(_Kernel_Trigonometry_GPU_KernelId, "Kernel_Trigonometry"u8);
        ...
        var bindGroupCache = (_Kernel_Trigonometry_GPU_Cache)pipelineCache.bindGroupCache;
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup))
        {
            ...
            bufferGroup = recorder.CreateBindGroup(pipelineCache.layouts[0], "Kernel_Trigonometry_buffers"u8);
        ...
        pass.SetBindGroupUniform(1, 0, ref bindGroupCache.uniformGroup, uniforms, pipelineCache, "Kernel_Trigonometry_uniforms"u8);
        
        pass.DispatchWorkgroups((buffers.length + 63) / 64, 1, 1);
    }

    private sealed class _Kernel_Trigonometry_GPU_Cache : BindGroupCache
    {
    ...
    private static readonly int _Kernel_Trigonometry_GPU_KernelId           =  KernelRegistry.NewKernelId("Kernel_TrigonometryKernel");
    ...
    private static ref readonly ComputeCache _Kernel_Trigonometry_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated)
        {
            ...
            bufferLayout = device.CreateBindGroupLayout(ShaderStage.Compute, _Kernel_Trigonometry_GPU_BufferLayoutKey, "Kernel_Trigonometry_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(ShaderStage.Compute, _Kernel_Trigonometry_GPU_UniformLayoutKey, "Kernel_Trigonometry_uniforms"u8);
        }
        using var shaderModule  = device.CreateShaderModule(_Kernel_Trigonometry_GPU_Shader(), "Kernel_Trigonometry"u8);
        var pipeline            = device.CreateComputePipeline(shaderModule, bufferLayout, uniformLayout, "Kernel_Trigonometry"u8);
        
        var bindGroupCache = new _Kernel_Trigonometry_GPU_Cache();
        return ref device.CreatePipelineCache(_Kernel_Trigonometry_GPU_KernelId, _Kernel_Trigonometry_GPU_WgslHash, pipeline, bufferLayout, uniformLayout, bindGroupCache);
    }
