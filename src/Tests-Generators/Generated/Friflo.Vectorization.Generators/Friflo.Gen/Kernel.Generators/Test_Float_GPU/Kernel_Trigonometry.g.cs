...
namespace Kernel.Generators
{
        ...
        in float           value)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup)) {
            ...
            bufferGroup = recorder.CreateBindGroupNew(pipelineCache.bufferLayout, entries, "Kernel_Trigonometry_buffers"u8);
        ...
        pass.SetUniformBindGroup(1, pipelineCache, ref bindGroupCache.uniformGroup, uniforms, "Kernel_Trigonometry_uniforms"u8);
    ...
    private static ref ComputeCache _Kernel_Trigonometry_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, false, _Kernel_Trigonometry_GPU_BufferLayoutKey, "Kernel_Trigonometry_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, true, _Kernel_Trigonometry_GPU_UniformLayoutKey, "Kernel_Trigonometry_uniforms"u8);
        }
