...
namespace Kernel.Generators
{
    ...
    private static ref WgpuEffect _Kernel_Trigonometry_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, false, _Kernel_Trigonometry_GPU_BufferLayoutKey, "Kernel_Trigonometry_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, true, _Kernel_Trigonometry_GPU_UniformLayoutKey, "Kernel_Trigonometry_uniforms"u8);
        }
