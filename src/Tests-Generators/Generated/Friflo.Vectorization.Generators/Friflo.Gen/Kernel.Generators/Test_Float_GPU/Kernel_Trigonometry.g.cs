...
namespace Kernel.Generators
{
    ...
    private static ref ComputeCache _Kernel_Trigonometry_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, _Kernel_Trigonometry_GPU_BufferLayoutKey, "Kernel_Trigonometry_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, _Kernel_Trigonometry_GPU_UniformLayoutKey, "Kernel_Trigonometry_uniforms"u8);
        }
