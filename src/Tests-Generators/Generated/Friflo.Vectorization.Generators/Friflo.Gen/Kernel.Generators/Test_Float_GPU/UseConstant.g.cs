...
namespace Kernel.Generators
{
        ...
        in InOutBuffer<float> position)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup)) {
            ...
            bufferGroup = recorder.CreateBindGroupNew(pipelineCache.bufferLayout, entries, "UseConstant_buffers"u8);
    ...
    private static ref ComputeCache _UseConstant_GPU_CreateComputeCache(WgpuDevice device)
    {
        // @group(0)
