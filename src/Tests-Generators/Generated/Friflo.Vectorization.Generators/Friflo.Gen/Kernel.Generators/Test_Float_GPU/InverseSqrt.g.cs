...
namespace Kernel.Generators
{
        ...
        in InOutBuffer<float> position)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup))
        {
            ...
            bufferGroup = recorder.CreateBindGroup(pipelineCache.bufferLayout, "InverseSqrt_buffers"u8);
        ...
        pass.SetBindGroupUniform(1, 0, ref bindGroupCache.uniformGroup, uniforms, pipelineCache, "InverseSqrt_uniforms"u8);
