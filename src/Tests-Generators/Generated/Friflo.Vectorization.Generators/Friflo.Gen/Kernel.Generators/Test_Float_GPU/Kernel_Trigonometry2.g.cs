...
namespace Kernel.Generators
{
        ...
        in InOutBuffer<float> position)
    {
        ...
        pass.SetBindGroupUniform(1, 0, ref bindGroupCache.uniformGroup, uniforms, pipelineCache, "Kernel_Trigonometry2_uniforms"u8);
    ...
    private static ref readonly ComputeCache _Kernel_Trigonometry2_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated)
        {
            ...
            bufferLayout = device.CreateBindGroupLayout(ShaderStage.Compute, _Kernel_Trigonometry2_GPU_BufferLayoutKey, "Kernel_Trigonometry2_buffers"u8);
        }
        // @group(1)
