...
namespace Kernel.Generators
{
        ...
        in InOutBuffer<float> position)
    {
        ...
        ref var effect = ref device.GetComputeEffect(_Kernel_Trigonometry2_GPU_KernelId, _Kernel_Trigonometry2_GPU_WgslHash);
        if (!effect.IsCreated) {
        ...
        if (!bufferGroup.IsCreated) {
            ...
            device.UpdateComputeCache(_Kernel_Trigonometry2_GPU_KernelId, bufferGroup, buffers.hash);
        }
        ...
        pass.SetUniformBindGroup(1, ref effect, uniforms, "Kernel_Trigonometry2_uniforms"u8);
    ...
    private static ref WgpuComputeEffect _Kernel_Trigonometry2_GPU_CreateEffect(WgpuDevice device)
    {
        // @group(0)
        ...
        return ref device.CreateComputeEffect(_Kernel_Trigonometry2_GPU_KernelId, _Kernel_Trigonometry2_GPU_WgslHash, pipeline, default, bufferLayout, uniformLayout);
    }
