...
namespace Kernel.Generators
{
        ...
        in InOutBuffer<float> position)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup)) {
            ...
            bufferGroup = recorder.CreateBindGroupNew(pipelineCache.bufferLayout, entries, "Kernel_Trigonometry2_buffers"u8);
        ...
        pass.SetUniformBindGroup(1, pipelineCache, ref bindGroupCache.uniformGroup, uniforms, "Kernel_Trigonometry2_uniforms"u8);
