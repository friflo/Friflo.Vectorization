...
namespace Kernel.Generators
{
        ...
        in InBuffer   <float> velocity)
    {
        ...
        ref readonly var pipelineCache = ref device.GetPipelineCache(_Kernel_Min_GPU_KernelId, _Kernel_Min_GPU_WgslHash);
    ...
    private static ref readonly ComputeCache _Kernel_Min_GPU_CreateComputeCache(WgpuDevice device)
    {
        // @group(0)
