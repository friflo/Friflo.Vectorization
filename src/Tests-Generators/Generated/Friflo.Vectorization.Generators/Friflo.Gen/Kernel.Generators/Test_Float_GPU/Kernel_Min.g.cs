...
namespace Kernel.Generators
{
        ...
        in InBuffer   <float> velocity)
    {
        ...
        if (!bufferGroup.IsCreated) {
            ...
            device.UpdateComputeCache(_Kernel_Min_GPU_KernelId, bufferGroup, buffers.hash);
        }
        ...
        pass.SetUniformBindGroup(1, ref effect, uniforms, "Kernel_Min_uniforms"u8);
    ...
    private static ref WgpuComputeEffect _Kernel_Min_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        return ref device.CreateComputeEffect(_Kernel_Min_GPU_KernelId, _Kernel_Min_GPU_WgslHash, pipeline, default, bufferLayout, uniformLayout);
    }
