...
namespace Kernel.Generators
{
        ...
        in InBuffer<float> velocity_)
    {
        ...
        recorder.Init(_Kernel_Min_GPU_KernelId);
        ...
        {
            ref var effect = ref device.GetEffect(_Kernel_Min_GPU_KernelId); // simple GpuEffect[] array lookup
            if (!effect.IsCreated) {
            ...
            if (!bufferGroup.IsCreated) {
                ...
                device.UpdateBufferCache(_Kernel_Min_GPU_KernelId, bufferGroup, buffers.hash);
            }
    ...
    private static readonly int _Kernel_Min_GPU_KernelId           = WgpuDevice.NewKernelId("Kernel_Min");
    ...
    private static ref WgpuEffect _Kernel_Min_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        return ref device.CreateEffect(_Kernel_Min_GPU_KernelId, pipeline, bufferLayout, uniformLayout);
    }
