...
namespace Kernel.Generators
{
        ...
        in InBuffer   <float> velocity)
    {
        ...
        pass.SetUniform(ref effect, uniforms, "Kernel_Min_uniforms"u8);
    ...
    private static ref WgpuEffect _Kernel_Min_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, false, _Kernel_Min_GPU_BufferLayoutKey, "Kernel_Min_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, true, _Kernel_Min_GPU_UniformLayoutKey, "Kernel_Min_uniforms"u8);
        }
        ...
        return ref device.CreateEffect(_Kernel_Min_GPU_KernelId, _Kernel_Min_GPU_WgslHash, pipeline, bufferLayout, uniformLayout);
    }
