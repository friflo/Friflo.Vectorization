...
namespace Kernel.Generators
{
        ...
        in float           value)
    {
        ...
        ref var effect = ref device.GetComputeEffect(_Kernel_Misc_GPU_KernelId, _Kernel_Misc_GPU_WgslHash);
        if (!effect.IsCreated) {
        ...
        if (!bufferGroup.IsCreated) {
            ...
            device.UpdateComputeCache(_Kernel_Misc_GPU_KernelId, bufferGroup, buffers.hash);
        }
        ...
        pass.SetUniformBindGroup(1, ref effect, uniforms, "Kernel_Misc_uniforms"u8);
    ...
    private static ref WgpuComputeEffect _Kernel_Misc_GPU_CreateEffect(WgpuDevice device)
    {
        // @group(0)
        ...
        return ref device.CreateComputeEffect(_Kernel_Misc_GPU_KernelId, _Kernel_Misc_GPU_WgslHash, pipeline, default, bufferLayout, uniformLayout);
    }
