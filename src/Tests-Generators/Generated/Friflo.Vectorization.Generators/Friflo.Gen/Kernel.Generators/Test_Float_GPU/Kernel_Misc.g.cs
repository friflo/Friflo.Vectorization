...
namespace Kernel.Generators
{
    ...
    private static ref ComputeCache _Kernel_Misc_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, _Kernel_Misc_GPU_BufferLayoutKey, "Kernel_Misc_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, _Kernel_Misc_GPU_UniformLayoutKey, "Kernel_Misc_uniforms"u8);
        }
