...
namespace Kernel.Generators
{
        ...
        in float           value)
    {
        ...
        if (!bindGroupCache.bufferGroup.TryGetValue(key, out var bufferGroup))
        {
            ...
            bufferGroup = recorder.CreateBindGroup(pipelineCache.bufferLayout, "Kernel_Misc_buffers"u8);
    ...
    private static ref readonly ComputeCache _Kernel_Misc_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated)
        {
            ...
            bufferLayout = device.CreateBindGroupLayout(ShaderStage.Compute, _Kernel_Misc_GPU_BufferLayoutKey, "Kernel_Misc_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(ShaderStage.Compute, _Kernel_Misc_GPU_UniformLayoutKey, "Kernel_Misc_uniforms"u8);
        }
        using var shaderModule  = device.CreateShaderModule(_Kernel_Misc_GPU_Shader(), "Kernel_Misc"u8);
