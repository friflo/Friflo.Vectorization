...
namespace Kernel.Generators
{
    ...
    private static ref WgpuEffect _Kernel_Misc_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, false, _Kernel_Misc_GPU_BufferLayoutKey, "Kernel_Misc_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, true, _Kernel_Misc_GPU_UniformLayoutKey, "Kernel_Misc_uniforms"u8);
        }
