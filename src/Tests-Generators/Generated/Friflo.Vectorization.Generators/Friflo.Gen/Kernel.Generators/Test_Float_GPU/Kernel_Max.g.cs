...
namespace Kernel.Generators
{
    ...
    private static ref WgpuEffect _Kernel_Max_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, false, _Kernel_Max_GPU_BufferLayoutKey, "Kernel_Max_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, true, _Kernel_Max_GPU_UniformLayoutKey, "Kernel_Max_uniforms"u8);
        }
