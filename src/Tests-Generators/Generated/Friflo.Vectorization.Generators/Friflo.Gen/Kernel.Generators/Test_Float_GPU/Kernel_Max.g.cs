...
namespace Kernel.Generators
{
        ...
        in InBuffer   <float> velocity)
    {
        ...
        ref var effect = ref device.GetEffect(_Kernel_Max_GPU_KernelId, _Kernel_Max_GPU_WgslHash);
        if (!effect.IsCreated) {
    ...
    private static ref WgpuEffect _Kernel_Max_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        return ref device.CreateEffect(_Kernel_Max_GPU_KernelId, _Kernel_Max_GPU_WgslHash, pipeline, bufferLayout, uniformLayout);
    }
