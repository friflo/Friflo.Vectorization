...
namespace Kernel.Generators
{
    ...
    private static ref ComputeCache _Kernel_Max_GPU_CreateComputeCache(WgpuDevice device)
    {
        ...
        if (!bufferLayout.IsCreated) {
            ...
            bufferLayout = device.CreateBindGroupLayout(buffers, ShaderStage.Compute, _Kernel_Max_GPU_BufferLayoutKey, "Kernel_Max_buffers"u8);
        }
        // @group(1)
        ...
        if (!uniformLayout.IsCreated) {
            ...
            uniformLayout = device.CreateBindGroupLayout(uniform, ShaderStage.Compute, _Kernel_Max_GPU_UniformLayoutKey, "Kernel_Max_uniforms"u8);
        }
