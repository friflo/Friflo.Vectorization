...
namespace Kernel.Generators
{
        ...
        in InBuffer<float> velocity_)
    {
        ...
        recorder.Init(_Kernel_Max_GPU_KernelId);
        ...
        {
            ref var effect = ref device.GetEffect(_Kernel_Max_GPU_KernelId); // simple GpuEffect[] array lookup
            if (!effect.IsCreated) {
    ...
    private static readonly int _Kernel_Max_GPU_KernelId           = KernelRegistry.NewKernelId("Kernel_Max");
    ...
    private static ref WgpuEffect _Kernel_Max_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        return ref device.CreateEffect(_Kernel_Max_GPU_KernelId, pipeline, bufferLayout, uniformLayout);
    }
