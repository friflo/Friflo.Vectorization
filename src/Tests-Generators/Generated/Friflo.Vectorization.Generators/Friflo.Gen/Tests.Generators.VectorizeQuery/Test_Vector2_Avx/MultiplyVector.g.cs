...
namespace Tests.Generators.VectorizeQuery
{
    public partial class Test_Vector2_Avx
    {
        ...
        public static ArchetypeQuery MultiplyVectorQuery(EntityStore _store, Vector2 vector3, bool vectorized = true)
        {
