...
namespace Tests.Generators.VectorizeQuery
{
    public partial class Test_Vector2_Avx
    {
        ...
        public static ArchetypeQuery Distance_Vector2Query(EntityStore _store, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _Distance_Vector2_Avx(_entities.Length, positionSpan, velocitySpan, lengthSpan);
                }
            EntityLoop:
    ...
    #region private members
        ...
        [SkipLocalsInit]
        private static unsafe int _Distance_Vector2_Avx(int count,
            ...
            Span<global::Tests.ECS.FloatComponent> length)
        {
            ...
            fixed (global::Tests.ECS.FloatComponent* length_first = length)
            {
                ...
                for (; i < paddedCount; i += 16)
                {
                    ...
                    Vector256<float> length_1;  // FloatComponent
