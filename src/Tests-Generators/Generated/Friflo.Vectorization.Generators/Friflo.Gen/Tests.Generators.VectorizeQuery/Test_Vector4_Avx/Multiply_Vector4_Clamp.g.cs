...
namespace Tests.Generators.VectorizeQuery
{
    public partial class Test_Vector4_Avx
    {
        ...
        public static ArchetypeQuery Multiply_Vector4_ClampQuery(EntityStore _store, Vector4 min, Vector4 max, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _Multiply_Vector4_Clamp_Avx(_entities.Length, positionSpan, min, max);
                }
            EntityLoop:
    ...
    #region private members
        ...
        [SkipLocalsInit]
        private static unsafe int _Multiply_Vector4_Clamp_Avx(int count,
