...
namespace Tests.Generators.VectorizeQuery
{
    public partial class Test_Vector4_Avx
    {
        ...
        public static ArchetypeQuery MultiplyVectorQuery(EntityStore _store, Vector4 vector4, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _MultiplyVector_Avx(_entities.Length, positionSpan, velocitySpan, vector4);
                }
            EntityLoop:
