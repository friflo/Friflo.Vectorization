            ...
            ReadOnlySpan<global::Tests.ECS.Velocity4> velocity)
        {
            ...
            fixed (global::Tests.ECS.Velocity4* velocity_first = velocity)
            {
                ...
                for (; i < paddedCount; i += 8)
                {
                    ...
                    var (temp0_0, temp0_1, temp0_2, temp0_3) = AvxVector4.Normalize(velocity_0, velocity_1, velocity_2, velocity_3);
                    position_0 = temp0_0;
                    position_1 = temp0_1;
                    position_2 = temp0_2;
                    position_3 = temp0_3;
