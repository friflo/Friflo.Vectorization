...
namespace Tests.Generators.VectorizeQuery
{
    public partial class Test_Locals_Avx
    {
        ...
        public static ArchetypeQuery MixedLocalsQuery(EntityStore _store, Vector2 vec, float scalar, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                var scalarCompSpan = chunk.Chunk2.GetComponentSpan();
                int n = 0;
    ...
    #region private members
            ...
            float scalar)
        {
            ...
            fixed (global::Tests.ECS.FloatComponent* scalarComp_first = scalarComp)
            {
                ...
                float* scalarComp_ptr = (float*)scalarComp_first;
