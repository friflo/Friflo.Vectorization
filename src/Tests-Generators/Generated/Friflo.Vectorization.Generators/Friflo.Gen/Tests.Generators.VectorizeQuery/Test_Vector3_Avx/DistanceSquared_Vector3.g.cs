...
namespace Tests.Generators.VectorizeQuery
{
    public partial class Test_Vector3_Avx
    {
        ...
        public static ArchetypeQuery DistanceSquared_Vector3Query(EntityStore _store, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _DistanceSquared_Vector3_Avx(_entities.Length, positionSpan, velocitySpan, lengthSpan);
                }
            EntityLoop:
    ...
    #region private members
        ...
        [SkipLocalsInit]
        private static unsafe int _DistanceSquared_Vector3_Avx(int count,
            ...
            Span<global::Tests.ECS.FloatComponent> length)
        {
            ...
            fixed (global::Tests.ECS.FloatComponent* length_first = length)
            {
                ...
                for (; i < paddedCount; i += 8)
                {
                    ...
                    length_0 = AvxVector3.DistanceSquared(position_0,position_1,position_2, velocity_0,velocity_1,velocity_2);
