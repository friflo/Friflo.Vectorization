...
public partial class Test_Float_GPU : KernelBase
{
    ...
    public void Test_Kernel_Multiply()
    {
        ...
        MultiplyKernel(position.InOut().Read(), velocity.In());
    ...
    public void Test_Kernel_Assign()
    {
        ...
        AssignKernel(gpuBuffer1.InOut().Read(), gpuBuffer2.In());
    ...
    public void Test_Kernel_Buffers()
    {
        ...
        AddKernel(gpuDst.InOut  (0, 10).Read(), gpuSrc.In(0, 10));

        for (int n = 50; n >= 10; n-= 10) {
            AddVector(scalar2.AsSpan(n, 9), scalar1.AsSpan   (n, 9));
            AddKernel(gpuDst.InOut  (n, 9).Read(), gpuSrc.In(n, 9));
        }
    ...
    public void Test_Kernel_Fma()
    {
        ...
        MoveKernel(gpuBuffer1.InOut().Read(), gpuBuffer2.In(), 42);
    ...
    public void Test_Kernel_UseConstant()
    {
        ...
        UseConstantKernel(gpuBuffer1.InOut().Read());
    ...
    public void Test_Kernel_InverseSqrt()
    {
        ...
        InverseSqrtKernel(gpuBuffer1.InOut().Read());
    ...
    public void Test_Kernel_Trigonometry()
    {
        ...
        Kernel_TrigonometryKernel(gpuBuffer1.InOut().Read(), gpuBuffer2.In(), 1.1f);
    ...
    public void Test_Kernel_Trigonometry2()
    {
        ...
        Kernel_Trigonometry2Kernel(gpuBuffer1.InOut().Read());
    ...
    public void Test_Kernel_Misc()
    {
        ...
        Kernel_MiscKernel(gpuBuffer1.InOut().Read(), gpuBuffer2.In(), 1.1f);
    ...
    public void Test_Kernel_Min()
    {
        ...
        Kernel_MinKernel(gpuBuffer1.InOut().Read(), gpuBuffer2.In());
    ...
    public void Test_Kernel_Max()
    {
        ...
        Kernel_MaxKernel(gpuBuffer1.InOut().Read(), gpuBuffer2.In());
    ...
    public void Test_Kernel_Clamp()
    {
        ...
        Kernel_ClampKernel(gpuBuffer1.InOut().Read(), gpuBuffer2.In(), 200);
    ...
    public void Test_Kernel_KernelOnly()
    {
        ...
        KernelOnlyKernel(position.InOut().Read(), velocity.In());
