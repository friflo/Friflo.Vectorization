...
private void DrawExample(TmDraw draw)
{
    ...
    // 8 Eckpunkte eines Würfels (Lokal)
    ...
    // 6 Würfelflächen
    (int i0, int i1, int i2, int i3, Vector3 norm)[] faces = [
    ...
    // Kräftige Palette für die 16 einfarbigen Würfel
    ReadOnlySpan<uint> cubePalette = [
