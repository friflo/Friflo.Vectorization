...
public class TextureTest : IRenderer
{
	...
	/* language=file-reference */   [VertexShader  ("Shaders/basic.vert.wgsl",                  vert: "main")]
	/* language=file-reference */   [FragmentShader("Shaders/sampleTextureMixColor.frag.wgsl",  frag: "main")]
