...
public static partial class RenderTest
{
    ...
    public static void DrawTriangles(RenderPass<MainWorld> pass, InBuffer<VertexData> triangles)
	{
        var buffers =
        ...
        // pass.SetUniformBindGroup(1, ref effect, uniforms, "Triangles_uniforms"u8);           // TODO 
    ...
    private static ref WgpuEffect Triangles_GPU_CreateEffect(WgpuDevice device)
    {
        ...
        var shaderModule    = device.CreateShaderModule(Triangles_GPU_Shader(), "Triangle"u8);
        var pipeline        = device.CreateComputePipeline(shaderModule, bufferLayout, uniformLayout, "Triangle"u8);
