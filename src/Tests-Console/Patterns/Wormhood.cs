...
public static partial class Wormhood
{
        ...
        Uniforms       	uniforms)
	{
        ...
        ref readonly var pipelineCache = ref device.GetPipelineCache(Wormhood_GPU_ShaderId, renderConfig, Wormhood_GPU_WgslHash);
        if (!pipelineCache.IsCreated) {
            pipelineCache = ref Wormhood_GPU_CreatePipelineCache(device, renderConfig);
        }
