...
public partial class RenderTest
{
        ...
        MyUniform               myUniform)
	{
        ...
        ref readonly var pipelineCache = ref device.GetPipelineCache(Triangles_GPU_ShaderId, renderConfig, Triangles_GPU_WgslHash); // PipelineCache device/config via two arrays 
        if (!pipelineCache.IsCreated) {
            pipelineCache = ref Triangles_GPU_CreatePipelineCache(device, renderConfig);
        }
