...
public partial class TextureTest
{
        ...
        GpuTextureView  material)
	{
        ...
        ref readonly var pipelineCache = ref device.GetPipelineCache(TextureTest_GPU_ShaderId, renderConfig, TextureTest_GPU_WgslHash);
        if (!pipelineCache.IsCreated) {
            pipelineCache = ref TextureTest_GPU_CreatePipelineCache(device, renderConfig);
        }
        ...
        int verticesBufferCount = pass.SetVertexBuffer(renderConfig, 0, verticesBuffer); // slot: 0 - [VertexBuffer(0)]  references:  desc.VertexState.buffers[0]
