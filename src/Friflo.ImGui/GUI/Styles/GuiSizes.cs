...
public struct GuiSizes
{
    ...
    public Vector2      ItemSpacing      { readonly get => itemSpacing;      set => itemSpacing      = Add(PaddingId.ItemSpacing,      value); }
...
#region internal
    ...
    private Padding2D Add(PaddingId id, Padding2D value) 
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private Vector2 Add(PaddingId id, Vector2 value) 
    {
        overrides.value |= 1UL << Unsafe.As<PaddingId, int>(ref id);
        return value;
    }
