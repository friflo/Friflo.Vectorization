...
@group(0) @binding(13) var texture12: texture_depth_2d_array;
@group(0) @binding(14) var texture12: texture_depth_cube;
@group(0) @binding(15) var texture12: texture_depth_cube_array;
